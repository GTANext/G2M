    ...
    <>
      {isAuthenticated ? (
        <DropdownMenu open={menuOpen} onOpenChange={setMenuOpen}>
          <DropdownMenuTrigger asChild>
            <button
              ...
              className="group flex h-10 items-center gap-2 rounded-full border border-black/6 bg-white/86 px-1.5 pr-2.5 text-slate-700 shadow-[0_10px_30px_rgba(15,23,42,0.08)] ring-1 ring-black/[0.03] backdrop-blur-xl transition-all hover:border-black/10 hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900/15 dark:border-white/10 dark:bg-white/[0.06] dark:text-slate-200 dark:ring-white/[0.04] dark:hover:bg-white/[0.09]"
            >
              <span className="relative flex size-7 shrink-0 items-center justify-center overflow-hidden rounded-full bg-slate-900 text-[11px] font-semibold text-white dark:bg-white dark:text-slate-900">
                {avatarUrl ? (
          ...
          <DropdownMenuContent
            align="end"
            sideOffset={10}
            className="w-[21rem] rounded-[24px] border border-black/6 bg-white/96 p-2 shadow-[0_24px_80px_rgba(15,23,42,0.16)] ring-1 ring-black/[0.04] backdrop-blur-2xl dark:border-white/10 dark:bg-[rgba(15,23,42,0.96)] dark:ring-white/[0.04]"
          >
            <div className="rounded-[20px] border border-black/5 bg-[linear-gradient(180deg,rgba(248,250,252,0.98),rgba(255,255,255,0.94))] p-4 ring-1 ring-black/[0.03] dark:border-white/10 dark:bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.03))] dark:ring-white/[0.03]">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <span className="inline-flex items-center rounded-full border border-black/6 bg-black/[0.03] px-2.5 py-1 text-[11px] font-medium text-slate-700 dark:border-white/10 dark:bg-white/[0.06] dark:text-slate-200">
                  {roleText}
                </span>
            ...
            <div className="grid gap-2 pt-2">
              ...
              >
                <span className="flex size-9 items-center justify-center rounded-2xl bg-slate-900 text-white dark:bg-white dark:text-slate-900">
        ...
        <Button
          variant="ghost"
          size="icon-sm"
          className="relative cursor-pointer rounded-full border border-black/6 bg-white/82 text-slate-600 shadow-[0_10px_28px_rgba(15,23,42,0.08)] ring-1 ring-black/[0.03] backdrop-blur-xl hover:bg-white hover:text-slate-950 dark:border-white/10 dark:bg-white/[0.06] dark:text-slate-300 dark:ring-white/[0.04] dark:hover:bg-white/[0.09] dark:hover:text-white"
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-sm overflow-hidden rounded-[28px] border border-black/6 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(248,250,252,0.96))] p-0 shadow-[0_28px_90px_rgba(15,23,42,0.16)] ring-1 ring-black/[0.04] dark:border-white/10 dark:bg-[linear-gradient(180deg,rgba(15,23,42,0.96),rgba(2,6,23,0.92))] dark:shadow-[0_28px_90px_rgba(0,0,0,0.34)] dark:ring-white/[0.04]">
          <div className="border-b border-black/5 px-6 py-5 dark:border-white/10">
            <DialogHeader className="gap-3">
              <span className="flex size-11 items-center justify-center rounded-2xl bg-slate-900 text-white dark:bg-white dark:text-slate-900">
                <User className="size-4" />
              </span>
              <DialogTitle className="text-xl tracking-tight text-slate-900 dark:text-slate-100">
                {t("auth.dialogTitle")}
              </DialogTitle>
            ...
            <form className="space-y-3" onSubmit={handleLoginSubmit}>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  disabled={isPending}
                  className="h-12 rounded-2xl border-black/8 bg-white px-4 shadow-none dark:border-white/10 dark:bg-white/[0.04]"
                />
              </div>
              ...
              <div className="grid gap-2 pt-2">
                <Button
                  type="submit"
                  className="h-12 w-full cursor-pointer rounded-2xl bg-slate-900 text-white shadow-none hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100"
                ...
                <Button
                  type="button"
                  variant="ghost"
                  className="h-11 w-full cursor-pointer rounded-2xl text-slate-600 hover:bg-slate-100 hover:text-slate-900 dark:text-slate-300 dark:hover:bg-white/[0.06] dark:hover:text-slate-100"
